...
<%--<script>
    $(document).ready(function () {
        ...
        $('#<%= Calendar3.ClientID %> td:not(.ajax__calendar_other)').on('click', function (e) {
            e.preventDefault();
            e.stopPropagation();
        });
    });
...
<div class="modal" id="myModal3">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <asp:Calendar ID="Calendar3" CssClass="calendarView" DayNameFormat="FirstLetter"     runat="server" BackColor="white"   CellPadding="4" 
